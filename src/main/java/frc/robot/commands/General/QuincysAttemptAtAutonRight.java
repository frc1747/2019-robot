...
public class QuincysAttemptAtAutonRight extends CommandGroup {
  /**
   * Add your docs here.
   */
  public QuincysAttemptAtAutonRight() {
    addSequential(new MakeSequential(
      new DriveProfiles("/home/lvuser/Quincys_Test_fwd_mir.csv"),
      new HPScore(),
      new DriveProfiles("/home/lvuser/Quincys_Test_2_rev_mir.csv"),
      new MakeParallel(
        new ActuateHPScoring(2000, true),
        new AutonTarget(2000)
      ),
      new ActuateHPScoring(500, false),
      new DriveProfiles("/home/lvuser/Quincys_Test_3_rev_mir.csv"),
