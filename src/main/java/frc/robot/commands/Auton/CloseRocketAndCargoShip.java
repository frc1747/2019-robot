...
public class CloseRocketAndCargoShip extends CommandGroup {

  public CloseRocketAndCargoShip() {
    addSequential(new MakeSequential(
      ...
      new DriveProfiles("/home/lvuser/pickup_to_close_cargo_rev_nor.csv")
    ));
  }
}
